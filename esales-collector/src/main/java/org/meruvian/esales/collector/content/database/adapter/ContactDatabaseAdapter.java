...
public class ContactDatabaseAdapter extends DefaultDatabaseAdapter {
    ...
    public void saveContacts(List<Contact> contacts) {
        for (Contact contact : contacts) {
            ...
            if (findContactByRefId(contact.getId()) == null) {
                ...
                if (contact.getLogInformation().getCreateDate() != null) {
                    contentValues.put(ContactDatabaseModel.CREATE_DATE, contact.getLogInformation().getCreateDate().getTime());
                } else {
                    contentValues.put(ContactDatabaseModel.CREATE_DATE, new Date().getTime());
                }

                if (contact.getLogInformation().getLastUpdateDate() != null) {
                    contentValues.put(ContactDatabaseModel.UPDATE_DATE, contact.getLogInformation().getLastUpdateDate().getTime());
                } else {
                    contentValues.put(ContactDatabaseModel.UPDATE_DATE, new Date().getTime());
                }
                ...
                Log.d(getClass().getSimpleName(), "Contact.RefId: " + contact.getId());
                contentValues.put(ContactDatabaseModel.REF_ID, contact.getId());
                ...
                context.getContentResolver().update(dbUriContact, contentValues,
                        ContactDatabaseModel.REF_ID + " = ?", new String[] { contact.getId() });
            }
        }
    }
