...
import org.meruvian.esales.collector.activity.AssigmentItemActivity;
 ...
 */
public class AgentItemFragment extends DefaultFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        listAgent.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(getActivity(), AssigmentItemActivity.class);
    ...
    private List<AssigmentDetail> findAgents(String assigmentId) {
        List<AssigmentDetail> assigmentDetails = assigmentDetailDbAdapter
                .findAssigmentDetailSettle(assigmentId,
                        AssigmentDetail.AssigmentDetailStatus.SETTLE.name());

        Log.d(getClass().getSimpleName(), "Size details: " + assigmentDetails.size());
