...
import org.meruvian.esales.collector.entity.Category;
...
public class ProductDatabaseAdapter {
    ...
    public Product findAllProductByRefId(String refId) {
        String criteria = ProductDatabaseModel.REF_ID + " = ? ";

        Cursor cursor = context.getContentResolver().query(dbUriProduct, null,
                criteria, new String[] { refId }, null);
    ...
    public void saveProduct(Product product) {
        ...
        if(findAllProductByRefId(product.getId()) == null) {
            UUID uuid = UUID.randomUUID();
            String id = String.valueOf(uuid);

            values.put(ProductDatabaseModel.ID, id);
            ...
            values.put(ProductDatabaseModel.REF_ID, product.getId());
            ...
            context.getContentResolver().update(dbUriProduct, values,
                    ProductDatabaseModel.REF_ID + " = ?", new String[] { product.getId() });
        }
    }
