...
import com.meruvian.pxc.selfservice.content.database.adapter.ProductUomDatabaseAdapter;
...
public class ProductUomsSyncTask extends AsyncTask<String, Void, JSONObject> {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        return ConnectionUtil.get(preferences.getString("server_url_point", "") + "/api/product/uoms?access_token=" + AuthenticationUtils.getCurrentAuthentication().getAccessToken());
    }
