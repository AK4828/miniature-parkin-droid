...
import com.meruvian.pxc.selfservice.entity.Payment;
...
public class PayGetJob extends Job {
    ...
    public void onRun() throws Throwable {
        ...
        response = request.get(new TypeReference<Payment>() {
        });
        ...
        if (r.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            ...
            Log.d(getClass().getSimpleName(), "Response Code :" + r.getStatusLine().getStatusCode() + "Entity ID :" + paymentId + "Ref ID :" + pmn.getId());
            EventBus.getDefault().post(new GenericEvent.RequestSuccess(PROCESS_ID, response, pmn.getId(), paymentId));
        } else {
